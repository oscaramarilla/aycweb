...
/**
 * HerramientasSection — Sección de herramientas operativas con Lead Magnet
 * ──────────────────────────────────────────────────────────────────────────
 * Renderiza la grilla de herramientas y captura clicks en la matriz PDF
 * para abrir el modal de captura de leads en vez de navegar a "#".
 */
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {HERRAMIENTAS_B2B.map((h) => {
              ...
              const isModal = h.href === "#matriz-pdf";
              ...
              return (
                <Tag
                  key={h.id}
                  {...linkProps}
                  onClick={(e) => handleClick(e, h.href)}
