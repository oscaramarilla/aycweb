    ...
    <div className="flex flex-col min-h-screen bg-zinc-950 text-zinc-50 font-sans pb-24 md:pb-0">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-zinc-900/50 p-10 rounded-[2rem] border border-zinc-800 hover:border-blue-600/50 transition-colors group relative overflow-hidden">
              ...
              <p className="text-zinc-400 leading-relaxed mb-8">Cortá la fuga de clientes. Diseñamos embudos donde el usuario entra, entiende tu valor y es dirigido exactamente hacia el cierre comercial.</p>
            ...
            <div className="bg-zinc-900/50 p-10 rounded-[2rem] border border-zinc-800 hover:border-emerald-600/50 transition-colors group relative overflow-hidden transform lg:-translate-y-4 shadow-2xl bg-gradient-to-b from-zinc-900 to-zinc-950">
              ...
              <p className="text-zinc-400 leading-relaxed mb-8">Dejá de hacer trabajo de robot. Sistematizamos tus procesos manuales para que coticés y documentés más rápido, con cero errores.</p>
              <ul className="space-y-4 mb-8">
            ...
            <div className="bg-zinc-900/50 p-10 rounded-[2rem] border border-zinc-800 hover:border-purple-600/50 transition-colors group relative overflow-hidden">
              ...
              <p className="text-zinc-400 leading-relaxed mb-8">Ingeniería pura para cuellos de botella específicos. Desarrollamos herramientas en la nube exclusivas para la operativa de tu industria.</p>
              <ul className="space-y-4 mb-8">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-zinc-400 leading-relaxed mb-8">Podemos comenzar con un Ecosistema de Entrada e ir inyectándole "módulos" a medida que tu empresa lo exija. Escalas a tu propio ritmo, sin pagar por cosas que aún no usás.</p>
              <div className="grid grid-cols-2 gap-4">
                {["CRM Ligero", "Pasarela de Pago Cripto/Fiat", "Catálogo Dinámico", "Cotizador en Vivo", "Sistema de Tickets", "Exportación a Excel/PDF"].map((modulo, i) => (
      ...
      <section className="py-24 bg-black text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6 relative z-10">
          ...
          <p className="text-xl text-zinc-400 mb-10 leading-relaxed">Revisemos tu proceso comercial actual, encontremos los cuellos de botella y diseñemos la arquitectura digital exacta para resolverlos.</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
             <Link href="/os" className="bg-blue-600 hover:bg-blue-500 text-white font-black py-4 px-8 rounded-xl transition-all shadow-[0_0_30px_-5px_rgba(37,99,235,0.4)] active:scale-95">Ver Planes de Implementación</Link>
            <a href={`https://wa.me/${whatsappNumber}?text=${whatsappMsg}`} target="_blank" rel="noopener noreferrer" className="bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 text-white font-bold py-4 px-8 rounded-xl transition-all">Agendar Diagnóstico Gratuito</a>
          </div>
        </div>
      </section>
    </div>
