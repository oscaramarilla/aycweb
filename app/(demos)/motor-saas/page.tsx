...
import { MotorAycwebConfig } from "@/lib/config/motorAycweb";
import { buildWhatsappUrl } from "@/lib/services/whatsappBuilderService";

export default function MotorAycwebLanding() {
  const { contact, hero, benefits } = MotorAycwebConfig;
  const whatsappMsg = buildWhatsappUrl(
    "Cliente SaaS",
    "Motor AYCweb SaaS - Solicitud de Demo",
    0
    ...
    <div className="flex flex-col min-h-screen bg-zinc-950 text-zinc-50 font-sans pb-24 md:pb-0">
      ...
      <section className="relative pt-20 pb-12 md:pt-28 md:pb-16 px-6 text-center overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="inline-flex items-center gap-2 mb-6 px-4 py-1.5 rounded-full border border-blue-900/50 bg-blue-950/30 text-sm font-semibold text-blue-400 shadow-inner">
            ...
            Motor AYCweb SaaS - Automatización de Presupuestos
          </div>
      ...
      <section className="py-24 bg-zinc-900 border-t border-zinc-800 text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-5xl font-black text-white mb-6">¿Listo para transformar tus presupuestos?</h2>
          <p className="text-zinc-400 text-lg mb-8 max-w-2xl mx-auto">
            Solicita una demostración gratuita de nuestro Motor AYCweb SaaS. Agiliza tus procesos, ahorra tiempo y aumenta tus ventas.
          </p>
