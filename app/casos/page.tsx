...
export default function CasosPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-zinc-950 text-zinc-50 font-sans pb-24 md:pb-0">
      ...
      {/* CASO 1: METAL MAD (Industria) */}
      <section id="metal-mad" className="py-24 bg-black border-b border-zinc-900 scroll-mt-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            <div className="flex-1 space-y-6">
              <div className="inline-flex items-center gap-2 bg-emerald-950/30 border border-emerald-900/50 px-3 py-1 rounded-full text-[10px] font-bold text-emerald-400 uppercase tracking-widest">
              ...
              <div className="bg-zinc-900/50 border border-zinc-800 p-6 rounded-2xl">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Las cotizaciones de mobiliario escolar a medida dependían de Excel manuales y cálculos mentales de flete. Un presupuesto formal tardaba hasta 2 horas en emitirse, causando pérdida de oportunidades frente a competidores más rápidos.
                </p>
              </div>
              ...
              <div className="bg-zinc-900/50 border border-zinc-800 p-6 rounded-2xl">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  Desarrollamos un Motor Logístico B2B conectado a variables en tiempo real (combustible Petropar, desgaste de flota, RRHH). El vendedor solo ingresa los kilómetros y el sistema ensambla un contrato PDF formal con la cotización exacta.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link href="/flete" className="bg-zinc-800 hover:bg-zinc-700 text-white font-bold py-3 px-6 rounded-xl transition-all text-center">
                  Ver Cotizador Logístico en vivo &rarr;
                </Link>
              </div>
            </div>

            <div className="w-full lg:w-1/3 bg-zinc-900 border border-zinc-800 rounded-3xl p-8 flex flex-col justify-center text-center shadow-2xl">
      ...
      <section id="legal" className="py-24 bg-zinc-950 border-b border-zinc-900 scroll-mt-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row-reverse gap-12 items-start">
            ...
            <div className="w-full lg:w-1/3 bg-black border border-blue-900/50 rounded-3xl p-8 flex flex-col justify-center text-center shadow-[0_0_40px_rgba(37,99,235,0.15)]">
