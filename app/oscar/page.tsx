...
export default function LandingAYC() {
  ...
  const mensajeWhatsApp = "Hola AYC! Quiero automatizar mi negocio y aumentar mis conversiones. 🚀";
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans selection:bg-blue-500/30">
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 px-6 max-w-5xl mx-auto text-center overflow-hidden">
        ...
        <div className="inline-block bg-blue-900/30 border border-blue-500/30 text-blue-400 px-4 py-1.5 rounded-full text-xs font-black tracking-widest uppercase mb-6 shadow-[0_0_15px_rgba(59,130,246,0.2)]">
          AYC: Automatizaciones & Conversiones
        </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-black mb-4">Creamos un ecosistema completo que:</h2>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-zinc-900 p-8 rounded-3xl border border-zinc-800 relative">
              ...
              <h3 className="text-xl font-black mb-3 mt-4 text-white">Ingeniería de Conversión</h3>
              <p className="text-zinc-400">Diseñamos páginas de aterrizaje enfocadas 100% en que cada visita se convierta en un lead cualificado.</p>
            </div>
            <div className="bg-zinc-900 p-8 rounded-3xl border border-zinc-800 relative">
              <span className="absolute -top-6 left-8 text-6xl font-black text-zinc-800">2</span>
              <h3 className="text-xl font-black mb-3 mt-4 text-white">Ruta Directa a WhatsApp</h3>
              <p className="text-zinc-400">Eliminamos formularios inútiles. Conectamos al cliente directo a donde cerrás las ventas.</p>
            </div>
            <div className="bg-zinc-900 p-8 rounded-3xl border border-zinc-800 relative">
              <span className="absolute -top-6 left-8 text-6xl font-black text-zinc-800">3</span>
              <h3 className="text-xl font-black mb-3 mt-4 text-white">Automatización Total</h3>
              <p className="text-zinc-400">Filtramos y hacemos seguimiento automático sin que pierdas tiempo ni una sola oportunidad.</p>
            </div>
          </div>
        </div>
      </section>

      {/* 💰 OFERTA Y PLANES (GLOBALES) */}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-zinc-900 p-8 rounded-3xl border border-zinc-800 flex flex-col">
              ...
              <p className="text-zinc-400 mb-6">El sistema ideal para empezar a captar leads.</p>
              <div className="text-4xl font-black text-white mb-8">$197 <span className="text-base font-medium text-zinc-500">USD</span></div>
              
              <ul className="space-y-4 mb-8 flex-1">
                {['Landing page optimizada', 'Integración WhatsApp Directo', 'Copywriting persuasivo', 'Configuración de Hosting / Dominio'].map((feature, i) => (
              ...
              <a href={linkWA} target="_blank" rel="noreferrer" className="w-full block text-center bg-zinc-800 hover:bg-zinc-700 text-white font-bold py-4 rounded-xl transition-colors">Comenzar Starter</a>
            </div>
            ...
            <div className="bg-gradient-to-b from-blue-900/40 to-zinc-900 p-8 rounded-3xl border-2 border-blue-500 flex flex-col relative transform md:-translate-y-4 shadow-[0_0_40px_rgba(59,130,246,0.15)]">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-blue-500 text-white px-4 py-1 rounded-full text-xs font-black tracking-wider uppercase whitespace-nowrap">Mejor Retorno de Inversión</div>
              <h3 className="text-2xl font-black text-white mb-2">💎 Plan Pro</h3>
              <p className="text-zinc-400 mb-6">La máquina B2B en piloto automático.</p>
              <div className="text-4xl font-black text-white mb-1">$497 <span className="text-base font-medium text-blue-300">USD</span></div>
              <p className="text-sm text-blue-400 font-bold mb-7">+ Mensualidad de infraestructura</p>
              
              <ul className="space-y-4 mb-8 flex-1">
                {['Todo lo del Plan Starter', 'Automatización de respuestas (Bot)', 'Setup de CRM y Seguimiento', 'Dashboard Privado de Métricas', 'Optimización constante (A/B)'].map((feature, i) => (
          ...
          <div className="mt-16 text-center">
            <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-4">Aceptamos Medios de Pago Globales</p>
            <div className="flex flex-wrap justify-center gap-3 md:gap-6">
              <div className="flex items-center gap-2 bg-zinc-900/80 border border-zinc-800 px-4 py-2 rounded-lg">
                <span className="text-xl">💳</span>
                <span className="text-sm font-bold text-zinc-300">USD / Tarjeta</span>
              </div>
              <div className="flex items-center gap-2 bg-zinc-900/80 border border-zinc-800 px-4 py-2 rounded-lg">
                <span className="text-xl">₿</span>
                <span className="text-sm font-bold text-zinc-300">Crypto (USDT/BTC)</span>
              </div>
              <div className="flex items-center gap-2 bg-zinc-900/80 border border-zinc-800 px-4 py-2 rounded-lg">
                <span className="text-xl">🇵🇾</span>
                <span className="text-sm font-bold text-zinc-300">Guaraníes (Transferencia)</span>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-6 bg-zinc-900/80 border-y border-white/5 text-center">
        <div className="max-w-3xl mx-auto">
          <p className="text-xl md:text-2xl text-zinc-300 font-medium italic">
            "Este sistema ya está ayudando a empresas B2B a escalar sus clientes calificados todos los días, rompiendo fronteras y sin depender del boca en boca."
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6 text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          <div className="inline-block bg-orange-500/10 border border-orange-500/30 text-orange-400 px-4 py-2 rounded-lg font-bold mb-8 animate-pulse">
            ⚠️ Setup limitado a 2 proyectos por mes para garantizar calidad.
          </div>
          
          <h2 className="text-4xl md:text-5xl font-black mb-8 text-white">¿Listo para escalar tus operaciones?</h2>
          <p className="text-xl text-zinc-400 mb-10">Hacé clic abajo y hablemos de cómo implementar Automation & Conversions en tu empresa.</p>
          ...
          <p className="mt-4 text-zinc-500 text-sm">Sin compromisos. Solo negocios.</p>
        </div>
      </section>

      {/* FOOTER SIMPLE */}
      <footer className="py-8 text-center text-zinc-600 text-sm border-t border-white/5 bg-zinc-950">
        <p>© {new Date().getFullYear()} AYC (Automation & Conversions). Elevando marcas globalmente.</p>
      </footer>
